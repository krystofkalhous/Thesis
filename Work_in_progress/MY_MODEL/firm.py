...
class Firm:
      def __init__(self,ide,country,A,phi,Lcountry,w,folder,name,run,delta,dividendRate,xi,iota,\
          ...
          ### ----------------------------------------------------------------
          ### MY CODE
                        spatial_position = 0.0): ### <- added spatial_position
                   

          self.firm_spatial_position = spatial_position # spatial position drawn from U[0, 1) that is later used in the Hoteling circle ### !!!?
          ### ----------------------------------------------------------------
