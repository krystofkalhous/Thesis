...
class Parameter:
      def __init__(self):
          self.name= 'muxSnCo1upsilon20.7polnnPolVar0.512' ### orginally: 'muxSnCo5upsilon20.7polModPolVar0.512' #1.625'#2.876'#2.231#1.625'#1.053#0.512'
          ...
          #Monte Carlo runs
          firstrun=0#
          lastrun= 2 ### originally: 49#
          self.Lrun=range(firstrun,lastrun+1)
          self.weSeedRun='yes'      
          # space and time
          self.ncycle=1001
          self.ncountry=1 ### originally: 5#(K)
          self.nconsumer=10_000 ### originally: 500 #1000 #(H) experimented also with 10_000
          ...
          # policy
          self.policyKind='nn'#'nn'#'ModAll'#'Mod' ### Originally: Mod
