                              ...
                              if (self.MloanSupply[j][0] in McountryFirm[countryFirm][ideFirm].Lcreditor)==False:
                                 ...
                                 if loan>0.001:
                                    ...
                                    if  ideBank!=McountryBank[countryBank][ideBank].ide:
                                        print('stop', stop)
                                    interestRate=McountryBank[countryBank][ideBank].computeInterestRate(leverage, loan, McountryFirm[countryFirm][ideFirm].firm_spatial_position) ### Added loan_amount and positions, change loaOffered to loan to not undercharge smaller loans than offered (screening costs), -> deleted bank_spatial position
