...
class Parameter:
      def __init__(self):
          ...
          self.regionalDividendRate=0.2 ### 0.0 ->try0.2
          ...
          self.useRegionalBanks={0: True, 1: True}  ### <-- toggle per country here
          ...
          # Build name: include per-country regional suffix
          ...
          self.name=name
          self.folder='/Users/krystofkalhous/Desktop/OUTPUT'+self.name
