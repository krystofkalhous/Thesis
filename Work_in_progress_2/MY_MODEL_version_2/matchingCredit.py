                              ...
                              if (self.MloanSupply[j][0] in McountryFirm[countryFirm][ideFirm].Lcreditor)==False:
                                 ...
                                 if loan>0.001:
                                    ...
                                    if  ideBank!=McountryBank[countryBank][ideBank].ide:
                                        print('stop', stop)
                                    interestRate=McountryBank[countryBank][ideBank].computeInterestRate(leverage, loanOffered, McountryBank[countryBank][ideBank].bank_spatial_position, McountryFirm[countryFirm][ideFirm].firm_spatial_position) ### Added bank_spatial_position and firm_spatial_position
