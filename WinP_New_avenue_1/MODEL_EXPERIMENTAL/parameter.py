...
class Parameter:
      def __init__(self):                         
          self.name= 'muxSnCo2upsilon20.7polnnPolVar0.512' ### orginally: 'muxSnCo5upsilon20.7polModPolVar0.512' #1.625'#2.876'#2.231#1.625'#1.053#0.512'
          ...
          self.propTradable=0.4 ### orginally: 0.4 #0.4#(c_T)           
          # firms
          self.A=10#(A^0)
